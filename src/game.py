...
from src.core.bullet import BulletTypes
...
from src.graphics_engine.geometry.parametric_geometry import SphereGeometry, CylinderGeometry
from src.graphics_engine.geometry.rectangle_geometry import RectangleGeometry
...
from src.graphics_engine.materials.basic_material import PointMaterial
from src.graphics_engine.materials.surface_material import SurfaceMaterial
from src.graphics_engine.materials.texture_material import TextureMaterial
from src.graphics_engine.materials.phong_material import PhongMaterial
...
class Game:
    ...
    def startup(self):
        ...
        # Eye
        text_mat = Texture("src/graphics_engine/textures/eye.png")
