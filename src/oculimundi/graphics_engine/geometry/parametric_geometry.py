...
import numpy as np
from oculimundi.graphics_engine.geometry.geometry import Geometry
from oculimundi.graphics_engine.geometry.polygon_geometry import PolygonGeometry
from oculimundi.graphics_engine.matrix import Matrix
