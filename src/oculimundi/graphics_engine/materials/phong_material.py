...
from oculimundi.graphics_engine.materials.material import Material

class PhongMaterial(Material):

    def __init__(self, texture=None, properties={}):

        with open("oculimundi/graphics_engine/shaders/phong_vertex.txt", 'r') as f:
            vertex_shader_code = f.readlines()
        with open("oculimundi/graphics_engine/shaders/phong_fragment.txt", 'r') as f:
